    ...
    <div>
      ...
      <div className="mt-10 admin-card">
        <div className="flex items-center justify-between">
          ...
          <Link to="/admin/leads" className="text-sm font-semibold text-lime-dark hover:underline">
            View all
          </Link>
        </div>
...
function QuickLink({ to, title, description }) {
  return (
    <Link to={to} className="admin-card block transition-transform hover:-translate-y-0.5">
